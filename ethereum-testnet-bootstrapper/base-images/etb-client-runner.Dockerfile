...
RUN apt-get update && apt-get install -y --no-install-recommends wget libgflags-dev libsnappy-dev zlib1g-dev libbz2-dev liblz4-dev libzstd-dev openjdk-17-jre 
